...
public:
    ...
    void setupUi(QMainWindow *CodeWindow)
    {
        ...
        CodeWindow->setWindowModality(Qt::NonModal);
        CodeWindow->setEnabled(true);
        CodeWindow->resize(640, 480);
        CodeWindow->setMinimumSize(QSize(0, 0));
        CodeWindow->setMouseTracking(false);
        CodeWindow->setFocusPolicy(Qt::StrongFocus);
        CodeWindow->setContextMenuPolicy(Qt::DefaultContextMenu);
        CodeWindow->setAcceptDrops(false);
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/res/edit_image/accessories-text-editor.svg"), QSize(), QIcon::Normal, QIcon::Off);
        CodeWindow->setWindowIcon(icon);
        CodeWindow->setAutoFillBackground(true);
        CodeWindow->setDocumentMode(false);
        CodeWindow->setDockNestingEnabled(false);
        CodeWindow->setDockOptions(QMainWindow::AllowTabbedDocks|QMainWindow::AnimatedDocks|QMainWindow::ForceTabbedDocks|QMainWindow::VerticalTabs);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/res/edit_image/document-new.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/res/edit_image/document-open.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionOpen->setIcon(icon2);
        actionOpen->setIconVisibleInMenu(false);
        actionSave = new QAction(CodeWindow);
        actionSave->setObjectName(QString::fromUtf8("actionSave"));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/res/edit_image/document-save.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionSave->setIcon(icon3);
        actionSave->setIconVisibleInMenu(false);
        actionSaveAs = new QAction(CodeWindow);
        actionSaveAs->setObjectName(QString::fromUtf8("actionSaveAs"));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/res/edit_image/document-save-as.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionSaveAs->setIcon(icon4);
        actionSaveAs->setIconVisibleInMenu(false);
        actionUndo = new QAction(CodeWindow);
        actionUndo->setObjectName(QString::fromUtf8("actionUndo"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/res/edit_image/edit-undo.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionUndo->setIcon(icon5);
        actionUndo->setIconVisibleInMenu(false);
        actionRedo = new QAction(CodeWindow);
        actionRedo->setObjectName(QString::fromUtf8("actionRedo"));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/res/edit_image/edit-redo.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionRedo->setIcon(icon6);
        actionRedo->setIconVisibleInMenu(false);
        actionCut = new QAction(CodeWindow);
        actionCut->setObjectName(QString::fromUtf8("actionCut"));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/res/edit_image/edit-cut.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionCut->setIcon(icon7);
        actionCut->setIconVisibleInMenu(false);
        actionCopy = new QAction(CodeWindow);
        actionCopy->setObjectName(QString::fromUtf8("actionCopy"));
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/res/edit_image/edit-copy.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionCopy->setIcon(icon8);
        actionCopy->setIconVisibleInMenu(false);
        actionPaste = new QAction(CodeWindow);
        actionPaste->setObjectName(QString::fromUtf8("actionPaste"));
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/res/edit_image/edit-paste.svg"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    {
        CodeWindow->setWindowTitle(QApplication::translate("CodeWindow", "QtCodePad", 0, QApplication::UnicodeUTF8));
